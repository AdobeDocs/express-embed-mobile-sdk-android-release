...
| [setAuthProvider](set-auth-provider.md) | <br>fun [setAuthProvider](set-auth-provider.md)(authProvider: [AuthProvider](../auth-provider/index.md))<br>Sets the authentication provider for this controller. The provider supplies AuthOption when authentication is needed. |
