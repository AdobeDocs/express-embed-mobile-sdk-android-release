...
| Name | Summary |
|---|---|
| [config](config.md) | <br>abstract val [config](config.md): [PreSignedInAuthConfig](../pre-signed-in-auth-config/index.md)?<br>Pre-signed-in authentication configuration |
