...
| Name | Summary |
|---|---|
| [getAsset](get-asset.md) | <br>abstract suspend fun [getAsset](get-asset.md)(assetConfig: AssetConfig): [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin.collections/list/index.html)&lt;OutputAsset&gt;<br>Gets the published assets from the current editing session |
